...
-(instancetype)init{
    if ([super init]) {
        ...
        self.tabBarItem.image = [UIImage imageNamed:@"tabar_add_normal"];
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    self.tabBarItem.selectedImage = [[UIImage imageNamed:@"tabar_add_selected"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
...
- (void)viewDidLoad {
    ...
    [_topView addSubview:({
        ...
        //UILabel * label1 = [[UILabel alloc]initWithFrame:CGRectMake(152, 34, 71, 17)];
    ...
    [_field1 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(_topView.mas_bottom).with.offset(33);
...
//
    ...
    [self.view addSubview:({
        ...
        _field4.placeholder = @"请输入手机号";
        _field4.borderStyle = UITextBorderStyleRoundedRect;
        _field4.layer.borderWidth = 0.5f;
